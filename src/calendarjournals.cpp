    ...
    : QObject(parent)
{
    ...
    QMetaObject::invokeMethod(&mWorker, "listNotebooks", Qt::QueuedConnection);
}
...
QVariant CalendarJournals::add(int position, const QString &body, const QString &color)
{
    ...
    mJournals.insert(position, item);
